---
title: Classroom policy on the use of generative AI
type: policy
aliases:
...
1. **Knowing when to use AI** — Not every task benefits from AI. Learning to recognise when AI is helpful (and when it isn't) is a core skill.
2. **Evaluating AI outputs critically** — AI sounds confident even when wrong. You must verify claims, check sources, and apply your own judgement.
3. **Using AI effectively** — Practical skills in prompting, structuring conversations, and getting useful outputs. This improves with practice.
4. **Creating with AI support** — Using AI to support your thinking and drafting while ensuring the intellectual contribution remains yours.
5. **Understanding ethical implications** — Recognising issues of bias, privacy, and appropriate use in professional contexts.
6. **Developing professional judgement** — Building the taste and discernment to know what "good" AI engagement looks like in your field.
...
2. Key outputs the AI produced
3. How you used, adapted, or rejected those outputs
4. What your original intellectual contribution was
