...
description: >-
  ...
  dialogue. This essay argues for reclaiming trust by shifting from institutional
  proxies to visible processes,
...
> - A three-tier framework — live working environment for visible iteration, preprint with DOI for persistent citation, and traditional journal publication for institutional recognition — bridges open and traditional models without demanding abandonment of existing structures.
...
Building bridges between traditional and open scholarly practice requires a framework that honours both approaches—maintaining what works in established practices while embracing the possibilities of connection, openness, and engagement. The three-tier model I propose offers such a bridge:
...
While this conceptual framework could be implemented through various technical stacks, my implementation using GitHub, Zenodo, and Netlify demonstrates how principles of open scholarly practice can guide practical technology choices.
